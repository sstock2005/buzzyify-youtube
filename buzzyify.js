...
async function getHighestImageIndex() {
    // Start from 1 and increment until an image doesn't exist
    let i = 1;
    while (await checkImageExistence(i)) {
        i++;
    }

    // The highest index is one less than the first index that doesn't exist
    highestImageIndex = i - 1;
}
////////////////////////
//  BrandonXLF Magic  //
////////////////////////
...
getHighestImageIndex()
    .then(() => {
        ...
        console.log(
            "buzzyify Loaded Successfully, " + highestImageIndex + " images detected. " + blacklistStatus
        );
    })